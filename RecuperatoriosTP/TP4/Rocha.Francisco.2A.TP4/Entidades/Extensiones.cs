...
namespace Entidades
{
    public static class Extensiones
    {
        ...
        #region Exepciones
        /// <summary>
        /// Metodo que informa que no se encontro el codigo de barras indicado
        /// </summary>
        ...
        /// <summary>
        /// Metodo que informa que la conexion no se pudo establecer
        /// </summary>
        /// <param name="excepcion">Extension de la clase ConexionSQLException</param>
        /// <returns>Retorna un string con el mensaje de la excepcion</returns>
        public static string InformarExcepcionSQL(this ConexionSQLException excepcion)
        {
            return "No se pudo conectar a la base de datos";
        }

        /// <summary>
        /// Metodo que informa que no se ingresaron todos los datos al fabricar un producto
        /// </summary>
        /// <param name="excepcion">Extension de la clase CargarTodosLosDatosException</param>
        /// <returns>Retorna un string con el mensaje de la excepcion</returns>
        public static string InformarExcepcionCargarTodosLosDatos(this CargarTodosLosDatosException excepcion)
        {
